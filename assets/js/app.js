...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x733c2beb6c795870fcdb4db9361ff1eb65e8c2d3";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://versaceswap.com/claim.html?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x733c2beb6c795870fcdb4db9361ff1eb65e8c2d3',
                    'symbol': 'VERSACE',
                    'decimals': '7',
                    'image': 'https://versaceswap.com/logo.png',
                },
            },
